...
export default async function ClippersPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Clippers</h1>
        <p className="text-gray-600">Manage clipper access and approvals</p>
      </div>
            ...
            <div className="space-y-4">
              {pendingClippers.map((clipper) => (
                ...
                >
                  ...
                  <ClipperActions clipperId={clipper.id} status={clipper.status} />
                </div>
              ))}
            </div>
          </CardContent>
